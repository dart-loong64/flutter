...
vars = {
  ...
  'dart_boringssl_rev': 'fc5966037c34f0624c71c6a5dffe097a0f0cbca6',
...
deps = {
  ...
  'https://github.com/loong64/boringssl.git' + '@' + Var('dart_boringssl_rev'),

  'engine/src/flutter/third_party/ai':
   Var('dart_git') + '/ai.git' + '@' + Var('dart_ai_rev'),

  'engine/src/flutter/third_party/dart':
   'https://github.com/dart-loong64/sdk' + '@' + '2e818c80eea8e68a600f896a999b9f40a9756796',
  ...
  'https://github.com/dart-loong64/libpng' + '@' + '4104686b82d573b3611087824500e331367973a9',
  ...
  Var('swiftshader_git') + '/SwiftShader.git' + '@' + 'bea72feae3cf98eafd793719150c3ec57a133b8e',
